<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <StringManager offline label="DetailedImages" v-model="item.detailedImages" :editMode="false" @change="change" />
            <div>
                <String label="ReturnAndExchangePolicy" v-model="item.returnAndExchangePolicy" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
