<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="DetailedImages" v-model="value.detailedImages" :editMode="editMode"/>
            <String label="ReturnAndExchangePolicy" v-model="value.returnAndExchangePolicy" :editMode="editMode"/>
        </v-card-text>
